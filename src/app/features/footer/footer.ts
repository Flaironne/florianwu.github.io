...
@Component({
  ...
  template: `
    <footer class="py-10 px-4 border-t border-zinc-800 bg-zinc-950">
      <div class="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">

        <!-- Copyright -->
        <p class="text-sm text-zinc-500 text-center sm:text-left">
          © 2025 Florian Wu. Tous droits réservés.
        </p>
        ...
        <!-- Built with -->
        <p class="text-xs text-zinc-600 text-center sm:text-right">
